...
export default defineConfig((/* ctx */) => {
  return {
    ...
    ssr: {
      ...
      pwa: false,
      // pwaOfflineHtmlFilename: 'offline.html', // do NOT use index.html as
      // name!
    ...
    electron: {
      ...
      // Electron preload scripts (if any) from /src-electron, WITHOUT file
      // extension
      preloadScripts: ["electron-preload"],

      // specify the debugging port to use for the Electron app when running in
      // development mode
      inspectPort: 5858,
    ...
    bex: {
      ...
      /**
       * The list of extra scripts (js/ts) not in your bex manifest that you
       * want to compile and use in your browser extension. Maybe dynamic use
       * them?
       *
