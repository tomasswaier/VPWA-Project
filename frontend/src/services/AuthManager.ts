// Stolen from kurice/vpwa2026 repo. Said during lecutre that it's allowed
...
// also triggereing listeners when storage key is changed from another
// browser tab
class AuthManager {
  ...
  // this is just shortcut for adding change listener which calls callback only
  // when token was removed
